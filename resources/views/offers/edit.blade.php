                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <select name="business_id" id="business_id" 
                                    class="w-full rounded-[50px] border border-colorTextTitle bg-white px-[30px] py-4 text-base leading-none outline-none" required>
                                    @foreach($businesses as $business)
                                        <option value="{{ $business->id }}" {{ isset($offer) && $offer->business_id == $business->id ? 'selected' : '' }}>
                                            {{ $business->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <input type="text" name="title" id="title" placeholder="Offer Title"
                            ...
                            <div>
                                ...
                                <textarea name="description" id="description" placeholder="Offer Description"
                            ...
                            <div>
                                ...
                                <input type="text" name="audience" id="audience" placeholder="Target Audience"
                                    value="{{ old('audience', $offer->audience ?? '') }}"
                                    class="w-full rounded-[50px] border border-colorTextTitle bg-white px-[30px] py-4 text-base leading-none outline-none">
                            </div>
                            <!-- Discount -->
                            <div>
