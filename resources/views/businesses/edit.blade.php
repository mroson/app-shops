            ...
            <div class="container">
                <div class="mx-auto max-w-[860px]">
                    ...
                    <div class="rounded-[10px] bg-white p-5 shadow-custom-1 sm:p-[50px]">
                        <!-- Business Form -->
                        <form action="{{ isset($business) ? route('businesses.update', $business) : route('businesses.store') }}" 
                              method="POST" 
    ...
    <p class="mt-2 text-sm text-gray-500">Usá Ctrl (Cmd en Mac) para seleccionar múltiples categorías.</p>
                                ...
                                <div>
                                    ...
                                    <textarea name="description" id="description" placeholder="Brief business description"
                                        class="w-full rounded-[20px] border border-colorTextTitle bg-white px-[30px] py-4 text-base leading-none outline-none">{{ old('description', $business->description ?? '') }}</textarea>
                                </div>
                                <!-- Address -->
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="url" name="google_maps_url" id="google_maps_url" placeholder="https://maps.google.com/..."
                                        value="{{ old('google_maps_url', $business->google_maps_url ?? '') }}"
                                        class="w-full rounded-[50px] border border-colorTextTitle bg-white px-[30px] py-4 text-base leading-none outline-none">
                                </div>
                            </div>
                            <!-- Submit Button -->
